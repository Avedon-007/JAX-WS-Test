 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://services.employeemanagement/", wsdlLocation = "http://localhost:8181/any/name/you/like/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8181/any/name/you/like/employeeservice?wsdl");
